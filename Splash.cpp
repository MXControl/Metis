 ...
 * Copyright (C) 2003-2005 by Bender
 * 
...
CSplash::CSplash(UINT nBitmapID, UINT nDuration /*= 2500*/)
{
...
BOOL CSplash::GetBitmapAndPalette(UINT nIDResource, CBitmap &bitmap, CPalette &pal)
{
